...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      htmlAttrs: { lang: 'ru' },
      title: 'ДОВОД — юридическая и экспертная помощь в Краснодаре',
      meta: [
        { name: 'description', content: 'Юридическая и экспертная компания «Довод» в Краснодаре: юридические услуги, независимая оценка и судебная экспертиза для физических лиц и бизнеса. Бесплатная консультация — ответим за 15 минут.' },
