...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      htmlAttrs: { lang: 'ru' },
      title: 'ДОВОД — экспертная организация в Краснодаре',
      meta: [
        { name: 'description', content: 'Экспертная организация «Довод» в Краснодаре: независимая оценка, судебная экспертиза, рецензирование и юридическое сопровождение для физических лиц и бизнеса. Бесплатная консультация — ответим за 15 минут.' },
